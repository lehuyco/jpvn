...
const UPLOAD_FOLDER= __basedir + '/public/uploads/projects/'
const UPLOAD_PATH = '/uploads/projects/'
const ADMIN_PATH = '/admin/projects/'
const VIEW_PATH = 'admin/projects/'
const Model = Project
...
var createOrUpdate = async (req, res, next) => {
  let { title, content, summary, language } = req.body
  var doc = req.doc
