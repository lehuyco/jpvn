...
const UPLOAD_FOLDER= __basedir + '/public/uploads/slides/'
const UPLOAD_PATH = '/uploads/slides/'
const ADMIN_PATH = '/admin/slides/'
const VIEW_PATH = 'admin/slides/'
const ModelTitle = 'slide'
...
var createOrUpdate = async (req, res, next) => {
  let { title, subtitle, content, url, btnText, language } = req.body
  var doc = req.doc
