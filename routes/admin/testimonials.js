...
const UPLOAD_FOLDER= __basedir + '/public/uploads/testimonials/'
const UPLOAD_PATH = '/uploads/testimonials/'
const ADMIN_PATH = '/admin/testimonials/'
const VIEW_PATH = 'admin/testimonials/'
...
var createOrUpdate = async (req, res, next) => {
  let { name, content, company, language } = req.body
  var doc = req.doc
  ...
  try {
    ...
    if (req.file) {
      ...
      var info = await sharp(targetDir + req.file.filename).resize(200, 200).toFile(targetDir + "medium.png")
