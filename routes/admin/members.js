...
const UPLOAD_FOLDER = __basedir + '/public/uploads/members/'
const UPLOAD_PATH = '/uploads/members/'
const ADMIN_PATH = '/admin/members/'
const VIEW_PATH = 'admin/members/'
...
var createOrUpdate = async (req, res, next) => {
    let { title, description, content, language } = req.body
    var doc = req.doc
