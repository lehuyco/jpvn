...
const UPLOAD_FOLDER= __basedir + '/public/uploads/settings/'
...
var createOrUpdate = async (req, res, next) => {
  let { title, slogan, description, address, hotline, email, facebook, zalo, twitter, youtube, keywords, language, company, vision, mission, philosophy, fax, copyright } = req.body
  var doc = req.doc
